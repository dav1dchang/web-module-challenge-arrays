...
console.log(is31Flavors(originalFlavors))//invoking function
...
addFlavor(originalFlavors)//invoking function
console.log(originalFlavors)//console logging the new array
...
removeLastFlavor(originalFlavors)//Invoking function
console.log(originalFlavors)//Logging updated originalFlavors list
...
function getFlavorByIndex(arrayHolder, index){
   return (arrayHolder[index]);
}//function
let givenIndex = getFlavorByIndex(originalFlavors, 2)//defining a variable and invoking the prior function
console.log(givenIndex);//verifying the return
...
removeFlavorByName(originalFlavors, "Vanilla");//invoking function
